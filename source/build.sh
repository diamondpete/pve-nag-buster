...
emit_emitter "$dst" proxmox_source apt.sources.proxmox EOFPROXMOX
emit_emitter "$dst" ceph_source apt.sources.ceph EOFCEPH
emit_emitter "$dst" debian_source apt.sources.debian EOFDEBIAN
